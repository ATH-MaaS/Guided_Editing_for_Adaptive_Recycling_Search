...
from VideoReward.utils import get_peft_state_non_lora_maybe_zero_3
        ...
        **kwargs,
        ...
        if inputs_embeds is None:
            ...
            if pixel_values_videos is not None:
                ...
                video_embeds = self.model.visual(pixel_values_videos, grid_thw=video_grid_thw).last_hidden_state
