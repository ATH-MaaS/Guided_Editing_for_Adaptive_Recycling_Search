...
def fetch_video(ele: dict, image_factor: int = IMAGE_FACTOR) -> torch.Tensor | list[Image.Image]:
    ...
    if isinstance(ele["video"], str):
        ...
        # import pdb; pdb.set_trace()
        nframes, _, height, width = video.shape #T,C,H,W
        ...
        video_reader_backend = "samplevideo"
        video = VIDEO_READER_BACKENDS[video_reader_backend](ele)
        # import pdb; pdb.set_trace()
        nframes, _, height, width = video.shape #T,W,H,W
